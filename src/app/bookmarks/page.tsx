...
type BookmarkWithAttention = Bookmark & {
  attention?: {
    id: string;
    title: string | null;
    slug: string | null;
...
function BookmarksContent() {
  ...
  const [bookmarks, setBookmarks] = useState<(BookmarkWithPost | BookmarkWithAttention)[]>([]);
    ...
    <div className="flex-1 min-w-0">
      ...
      {loading ? (
        <div className="space-y-0">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="border-b border-border px-4 py-4 space-y-2">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <Link
                  ...
                  className="group"
                >
                  <p className="text-[13px] font-bold text-foreground leading-snug group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                    {b.target_type === "attention" ? "Attention" : "Post"} · {b.target_id.slice(0, 8)}
                  </p>
                </Link>
